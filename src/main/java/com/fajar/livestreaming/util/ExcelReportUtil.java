...
import static com.fajar.livestreaming.util.MapUtil.objectEquals;
...
import com.fajar.livestreaming.entity.setting.EntityElement;
...
//					continue elementLoop;
				...
				}else if(field.getType().equals(Date.class) || objectEquals(fieldType, FieldType.FIELD_TYPE_DATE, FieldType.FIELD_TYPE_DATETIME)) {
