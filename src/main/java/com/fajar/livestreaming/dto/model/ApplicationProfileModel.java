...
import static com.fajar.livestreaming.constants.FieldType.FIELD_TYPE_TEXTAREA;
...
import com.fajar.livestreaming.constants.FontAwesomeIcon;
import com.fajar.livestreaming.entity.ApplicationProfile;
import com.fasterxml.jackson.annotation.JsonIgnore;

import lombok.Data;

@Dto(ignoreBaseField = false, updateService = "shopProfileUpdateService")//, entityClass = ApplicationProfile.class)
@Data
